...
namespace SimpleWebAppMVC
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // checking my connection to mySQL database
            if (useMySQL)
            {
                string connectionStatus = CheckMySQLDatabaseConnection(connectionString);
        ...
        {
            string returnStatus = "Connection IS NOT working.";

            MySqlConnection mySQLConn = new MySqlConnection(connectionString);
            mySQLConn.Open();
            var temp = mySQLConn.State.ToString();
            if (mySQLConn.State == ConnectionState.Open && temp == "Open")
            {
