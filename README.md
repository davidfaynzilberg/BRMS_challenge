...
Database creation is in the CreateDatabaseSqlQuery.sql file

When you running the solution please do multiple Startup Project (image is attached)

Please call me if you have any questions 770 851-92625
